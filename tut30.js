console.log('Exercise: Using a dictionary API ');

// You have to pretend to use word API which will contain an object and you have to print defination from all the results of that word API. 
...
function populate() {
    ...
    results.forEach(element => {
       html += `<li class="list-group-item list-group-item-light">One of the definations of example is ${element.defination} </li>`;
    });
